...
const COMMANDS = [
	...
	preload("res://addons/addon_lib/gdsh_lib/tree/duplicate/duplicate.gd"),
	preload("res://addons/addon_lib/gdsh_lib/tree/free/free.gd"),
	preload("res://addons/addon_lib/gdsh_lib/tree/group/group.gd"),
	preload("res://addons/addon_lib/gdsh_lib/tree/index/index.gd"),
	...
	preload("res://addons/addon_lib/gdsh_lib/tree/parent/parent.gd"),
